...
| v0.6.0 | Invite | `tekt space invite` writes the invitation and copies it to the clipboard; `tekt space open`; a plain warning for over-long paths | #61 · #58 | in progress |
| v0.7.0+ | From the queue | Claude Desktop on Linux (#24/#25), RcloneView as a Spaces GUI (#31), agent runners (#36–#38, #27, #32) | | queue |
