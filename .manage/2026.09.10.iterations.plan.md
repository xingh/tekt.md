...
| v0.7.0 | See your Spaces | `tekt space gui`: RcloneView (freemium) as a point-and-click window onto your storage (Homebrew cask, Windows installer, Linux AppImage) | #31 | in progress |
| v0.8.0+ | From the queue | Claude Desktop on Linux (#24/#25), agent runners (#36–#38, #27, #32) | | queue |
