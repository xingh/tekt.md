...
| v0.4.0 | Shared skills | Skills in a Space appear in everyone's Claude Code after sync; `tekt skill new/list` | #55 · #46 | in progress |
| v0.5.0 | Solid ground | Windows winget preflight and honest `[OK]`s, `gh` on every OS | #28 · #26 | planned |
