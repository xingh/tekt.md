...
| v0.8.0 | More AI apps | Install Codex CLI, opencode and crush; `tekt connect` reaches opencode (JSON merge, JSONC left alone) and crush (a marked `crushrc` block) | #64 · #29 #36 #37 | in progress |
