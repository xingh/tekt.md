...
| v0.2.0 | Spaces | `tekt space add/list/sync/remove/autosync`, the `tekt` command, MCPHub `/spaces`, /spaces/ guide, changelog | #53 | in progress |
| v0.3.0 | Connect | `tekt connect`: your Spaces in Claude Code, Claude Desktop and Codex in one command | #54 · #29 | next |
