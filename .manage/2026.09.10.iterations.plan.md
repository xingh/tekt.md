...
| v0.5.0 | Solid ground | Windows winget preflight and honest `[OK]`s, `gh` on every OS | #28 · #26 | in progress |
| v0.6.0+ | From the queue | Claude Desktop on Linux (#24/#25), RcloneView as a Spaces GUI (#31), agent runners (#36–#38, #27, #32) | | queue |
